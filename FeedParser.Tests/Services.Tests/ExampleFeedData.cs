...
/// <summary>
///   Example feed data for use by tests. This is a separate file to get around an incorrect JetBrains warning. And
///   these are public a another project also depends on these.
/// </summary>
public static class ExampleFeedData
{
...
&lt;/div&gt;&lt;/div&gt;</content>
    ...
    public const string TestDiscourseFeedContent = @"<?xml version=""1.0"" encoding=""UTF-8"" ?>
...
";
    ...
    public const string RemapToHtmlInput = @"<?xml version=""1.0"" encoding=""UTF-8""?>
<feed xmlns=""http://www.w3.org/2005/Atom"" xmlns:media=""http://search.yahoo.com/mrss/"" xml:lang=""en-US"">
  <id>tag:github.com,2008:/organizations/Revolutionary-Games/user</id>
  <link type=""text/html"" rel=""alternate"" href=""https://github.com/organizations/Revolutionary-Games/user""/>
  <link type=""application/atom+xml"" rel=""self"" href=""https://github.com/organizations/Revolutionary-Games/user.private.atom?token=abcd""/>
...
&lt;/div&gt;&lt;/div&gt;</content>
    ...
    public const string RemapToHtmlOutput = @"<div class=""custom-feed-item-class feed-test"">
